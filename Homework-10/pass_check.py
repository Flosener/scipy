from test_dijkstra import test_find_shortest_path
from test_runtime import test_calculate_runtime
from test_pit import test_find_global_minimum

import sys

SUBTASKS = {
    "Dijkstra": (test_find_shortest_path, 10),
    "Runtime": (test_calculate_runtime, 10),
    "Pit": (test_find_global_minimum, 10)
}
